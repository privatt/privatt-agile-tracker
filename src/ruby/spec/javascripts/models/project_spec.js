describe('Project model', function() {
  ...
  beforeEach(function() {
    ...
    this.project = new AgileTracker.Project({
  ...
  describe("appendIteration", function() {
    ...
    it("should add the first iteration to the array", function() {
      var stub = sinon.stub(AgileTracker.Iteration, 'createMissingIterations');
      stub.returns([]);
    ...
    it("should create missing iterations if required", function() {
      var spy = sinon.spy(AgileTracker.Iteration, 'createMissingIterations');
